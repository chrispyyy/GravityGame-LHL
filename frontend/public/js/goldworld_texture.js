...
module.exports = function(scene, planet){
  ...
  goldworldMaterial = new BABYLON.StandardMaterial("goldworld_texture", scene);

  goldworldMaterial.diffuseTexture = new BABYLON.Texture("./public/images/goldmap.jpg", scene);

  goldworldMaterial.bumpTexture = new BABYLON.Texture("./public/images/goldbump.jpg", scene);

  goldworldMaterial.specularColor = new BABYLON.Color3(0,0,0);

  planet.canvasObject.material = goldworldMaterial;
